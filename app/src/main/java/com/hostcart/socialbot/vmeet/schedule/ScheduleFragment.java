package com.hostcart.socialbot.vmeet.schedule;
...
public class ScheduleFragment extends Fragment implements DatabaseManager.OnDatabaseDataChanged, View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (SharedPreferencesManager.getThemeMode().equals(AppUtils.THEME_DARK)) {
            view = inflater.inflate(R.layout.fragment_vmeet_schedule_dark, container, false);
        } else {
            view = inflater.inflate(R.layout.fragment_vmeet_schedule_light, container, false);
        }
        initWithView(view);
    ...
    private void getData(){
        databaseManager.getScheduleByUser(FireManager.getUid());
    }
