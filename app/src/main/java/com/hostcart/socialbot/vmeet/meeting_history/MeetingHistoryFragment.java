package com.hostcart.socialbot.vmeet.meeting_history;
...
public class MeetingHistoryFragment extends Fragment implements DatabaseManager.OnDatabaseDataChanged {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (SharedPreferencesManager.getThemeMode().equals(AppUtils.THEME_DARK)) {
            view = inflater.inflate(R.layout.fragment_meeting_history_dark, container, false);
        } else {
            view = inflater.inflate(R.layout.fragment_meeting_history_light, container, false);
        }
        initWithView(view);
    ...
    private void getData(){
        databaseManager.getMeetingHistoryByUser(FireManager.getUid());
    }
