package com.hostcart.socialbot.vmeet.firebase_db;
...
import com.hostcart.socialbot.vmeet.bean.Schedule;
...
public class DatabaseManager {
    ...
    public void initUsers() {
        FireConstants.usersRef.addValueEventListener(new ValueEventListener() {
            @Override
    ...
    public void addUser(UserInfo bean) {
        FireConstants.usersRef.child(bean.getUid()).setValue(bean).addOnSuccessListener(aVoid -> {
    ...
    public void updateUser(UserInfo bean) {
        DatabaseReference db = FireConstants.usersRef.child(bean.getUid());
    ...
    public void getUser(final String id) {
        Query query = FireConstants.usersRef.orderByChild("id").equalTo(id);
    ...
    public void deleteUser(UserInfo bean) {
        FireConstants.usersRef.child(bean.getUid()).removeValue((databaseError, databaseReference) -> {
