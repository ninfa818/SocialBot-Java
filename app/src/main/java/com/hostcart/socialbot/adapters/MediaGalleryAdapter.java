...
import com.hostcart.socialbot.activities.FullscreenActivity;
import com.hostcart.socialbot.activities.MediaGalleryActivity;
...
public class MediaGalleryAdapter extends RecyclerView.Adapter {
    ...
    private MediaGalleryActivity activity;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (!image.isVideo()) {
            ...
            //get video thumbnail
            byte[] videoThumb = BitmapUtils.encodeImageAsBytes(image.getVideoThumb());

            Glide.with(context).asBitmap().load(videoThumb).placeholder(R.drawable.image_placeholder).into(mHolder.imageViewGallery);

//            mHolder.imageViewGallery.setImageBitmap(videoThumb);
