...
//                mHolder.imageViewMedia.setImageBitmap(videoThumb);
                //show image thumb
                Glide.with(context).asBitmap().load(videoThumb).placeholder(R.drawable.image_placeholder).into(mHolder.imageViewMedia);
