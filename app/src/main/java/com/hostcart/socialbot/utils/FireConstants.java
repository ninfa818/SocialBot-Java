...
public class FireConstants {
    ...
    // friend request
    public static final DatabaseReference friendRequestRef = mainRef.child("friendRequest");

    // friends
    public static final DatabaseReference friendsRef = mainRef.child("friends");

    //Posts of a user
    public static final DatabaseReference postsRef = mainRef.child("posts");

    //More Section
    public static final DatabaseReference moreRef = mainRef.child("moresection");

    // languages of a user
    public static final DatabaseReference languageRef = mainRef.child("languages");
    ...
    public static final StorageReference postsStorageRef = storageRef.child("posts");
    ...
    public static DatabaseReference getMyPostRef() {
        return postsRef.child(FireManager.getUid());
    }
