...
import com.hostcart.socialbot.model.realms.DeletedMessage;
import com.hostcart.socialbot.model.realms.FireCall;
import com.hostcart.socialbot.model.realms.Group;
import com.hostcart.socialbot.model.realms.JobId;
...
public class RealmHelper {
    ...
    public void updateMessageContent( Message message, String change ) {
        if (message == null) return;

        realm.beginTransaction();

        message.setContent(change);
        realm.commitTransaction();
    }
...
//                .equalTo(DBConstants.IS_STORED_IN_CONTACTS, true)
    ...
    public void deleteUser(RealmResults<User> users, User user ) {
        realm.beginTransaction();
        users.deleteFromRealm(users.indexOf(user));
        realm.commitTransaction();
    }
    ...
    public void setCallAsMissed(String callId) {
        ...
        realm.beginTransaction();
        fireCall.setType(FireCallType.MISSED);
        realm.commitTransaction();
    }
    ...
    public void setCallAsAnswered(String callId) {
        ...
        if (fireCall == null) return;
        realm.beginTransaction();
        fireCall.setType(FireCallType.ANSWERED);
        realm.commitTransaction();
    }
    ...
    public boolean isCallCancelled(String callId) {
        ...
        return fireCall.getType() == FireCallType.MISSED;
