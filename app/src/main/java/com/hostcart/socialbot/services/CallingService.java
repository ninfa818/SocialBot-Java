...
import com.hostcart.socialbot.utils.AudioHelper;
...
import com.hostcart.socialbot.utils.ProximitySensor;
import com.hostcart.socialbot.utils.RealmHelper;
import com.hostcart.socialbot.utils.RingtonePlayer;
import com.hostcart.socialbot.utils.SharedPreferencesManager;
import com.hostcart.socialbot.utils.SinchConfig;
...
public class CallingService extends Service implements VideoCallListener, ProximitySensor.Delegate, AudioManager.OnAudioFocusChangeListener {
    ...
    public class SinchServiceInterface extends Binder {
        ...
        NotificationResult relayRemotePushNotificationPayload(final Map payload) {
            if (mSinchClient == null) {
                createClient();
            }
    ...
    private class SinchCallClientListener implements CallClientListener {
        ...
        public void onIncomingCall(CallClient callClient, final Call call) {
            ...
            FireManager.isCallCancelled(call.getRemoteUserId(), call.getCallId(), isCancelled -> {
