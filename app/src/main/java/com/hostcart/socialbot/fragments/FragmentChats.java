...
public class FragmentChats extends BaseFragment implements GroupTyping.GroupTypingListener {
    ...
    private RealmResults<Chat> chatList;
    private OrderedRealmCollectionChangeListener<RealmResults<Chat>> changeListener;
    private ValueEventListener typingEventListener, voiceMessageListener, lastMessageStatListener;

    private List<GroupTyping> groupTypingList;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (SharedPreferencesManager.getThemeMode().equals(AppUtils.THEME_DARK)) {
            view = inflater.inflate(R.layout.fragment_chats_dark, container, false);
        } else {
            view = inflater.inflate(R.layout.fragment_chats_light, container, false);
        }
    ...
    private void listenForMessagesChanges() {
        changeListener = (chats, changeSet) -> {
